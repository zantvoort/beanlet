 ...
 */
public class FieldInjectionImpl implements SetterInjection {
    
    private final Field field;
    private final Object injectant;
    
    public FieldInjectionImpl(Field field) {
        this(field, null);
    }
    
    public FieldInjectionImpl(Field field, Object injectant) {
        this.field = field;
