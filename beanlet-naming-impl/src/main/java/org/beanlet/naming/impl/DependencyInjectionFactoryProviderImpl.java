...
public final class DependencyInjectionFactoryProviderImpl extends 
    ...
    public List<DependencyInjectionFactory> getDependencyInjectionFactories(
        ...
        factories.add(new NamingDependencyInjectionFactoryImpl(configuration));
        factories.add(new NamingWireByNameDependencyInjectionFactoryImpl(configuration));
        factories.add(new NamingWireByTypeDependencyInjectionFactoryImpl(configuration));
