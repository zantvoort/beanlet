 ...
 */
public final class SelfNamingBeanletConfigurationValidatorImpl extends
        SingleElementBeanletConfigurationValidator<SelfNaming> {
    
    public Class<SelfNaming> annotationType() {
    ...
    public Class<?>[] getExceptionTypes() {
        return new Class[]{MalformedObjectNameException.class};
    }
