 ...
 */
public final class WebFilterObjectFactoryProviderImpl extends AbstractProvider
    ...
    public <T> ObjectFactory<T> getObjectFactory(
        ...
        if (WebConstants.isWebServletSupported()) {
            if (configuration instanceof BeanletConfiguration) {
                ...
                final WebFilter annotation = domain.getDeclaration(
                ...
                if (annotation != null && annotation.createFilter()) {
                    ...
                    if (constructor == null) {
                        throw new BeanletCreationException(configuration.getComponentName(),
                                "WebFilter MUST have a public zero-argument constructor.");
                    }
                    ...
                    factory = new ObjectFactory<T>() {
                        ...
                        public T newInstance() throws ComponentCreationException {
                            ...
                            try {
                                return (T) servletContext.createFilter(cls);
