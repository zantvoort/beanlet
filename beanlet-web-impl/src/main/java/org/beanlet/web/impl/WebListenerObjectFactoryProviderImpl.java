 ...
 */
public final class WebListenerObjectFactoryProviderImpl extends AbstractProvider
    ...
    public <T> ObjectFactory<T> getObjectFactory(
        ...
        if (WebConstants.isWebServletSupported()) {
            if (configuration instanceof BeanletConfiguration) {
                ...
                final WebListener annotation = domain.getDeclaration(
                ...
                if (annotation != null && annotation.createListener()) {
                    ...
                    factory = new ObjectFactory<T>() {
                        ...
                        public T newInstance() throws ComponentCreationException {
                            ...
                            try {
                                return (T) servletContext.createListener(cls);
