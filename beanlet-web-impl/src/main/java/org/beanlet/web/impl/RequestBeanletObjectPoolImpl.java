 ...
 */
public final class RequestBeanletObjectPoolImpl<T> implements 
    ...
    public RequestBeanletObjectPoolImpl(String componentName, boolean lazy, 
            boolean destroyOnDiscard) {
    ...
    public ComponentObject<T> getComponentObject() throws 
        ...
        try {
            ...
            try {
                ...
                if (pool == null) {
                    final ObjectPool<ComponentObject<T>> tmp = 
                    ...
                    RequestContextListener.setRequestDestroyHook(new Runnable() {
                        public void run() {
                            lock.lock();
                            try {
                                map.remove(request);
