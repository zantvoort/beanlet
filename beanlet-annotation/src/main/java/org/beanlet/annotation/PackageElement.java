 ...
 */
public final class PackageElement implements Element {
    
    public static PackageElement instance(Package pkg) {
        return new PackageElement(pkg);
    }
     ...
     */
    private PackageElement(Package pkg) {
        if (pkg == null) {
    ...
    public boolean isElementOf(Class<?> cls) {
        return pkg.equals(cls.getPackage());
    }
    ...
    public <T extends Annotation> ElementAnnotation<PackageElement, T> 
    ...
    public boolean equals(Object obj) {
        if (obj instanceof PackageElement) {
            return getPackage().equals(((PackageElement) obj).getPackage());
        }
        return false;
    }
    ...
    private static class ElementAnnotationImpl<T extends Annotation> 
            implements ElementAnnotation<PackageElement, T> {
        
        private final PackageElement element;
        private final T annotation;

        private ElementAnnotationImpl(PackageElement element, T annotation) {
            if (annotation == null) {
                throw new NullPointerException();
            }
