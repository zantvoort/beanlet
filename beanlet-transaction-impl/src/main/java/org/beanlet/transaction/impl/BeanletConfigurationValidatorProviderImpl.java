...
public final class BeanletConfigurationValidatorProviderImpl extends AbstractProvider
    ...
    public List<BeanletConfigurationValidator> getBeanletConfigurationValidators() {
        ...
        list.add(new GenericBeanletConfigurationValidatorImpl());
        list.add(new AfterBeginBeanletConfigurationValidatorImpl());
        list.add(new AfterCompletionBeanletConfigurationValidatorImpl());
        list.add(new BeforeCompletionBeanletConfigurationValidatorImpl());
