 ...
 */
public final class TransactionDependencyInspectorProviderImpl implements 
    ...
    public List<DependencyInspector> getDependencyInspectors(
        ...
        return Collections.<DependencyInspector>singletonList(
                new TransactionDependencyInspectorImpl(configuration));
    }
}
