 ...
 */
public final class BeanletClassResolverProvider 
        extends AbstractProvider implements ClassResolverProvider {
    
    public List<ClassResolver> getClassResolvers() {
        List<ClassResolver> list = new ArrayList<ClassResolver>();
        list.add(new TransactionAttributeClassResolverImpl());
