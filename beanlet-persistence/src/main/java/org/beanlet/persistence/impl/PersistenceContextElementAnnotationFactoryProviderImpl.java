 ...
 */
public class PersistenceContextElementAnnotationFactoryProviderImpl extends AbstractProvider 
    ...
    public List<ElementAnnotationFactory> getElementAnnotationFactories() {
        ...
        xpath.setNamespaceContext(PERSISTENCE_NAMESPACE_CONTEXT);
        ...
        ElementAnnotationFactory factory = new AbstractElementAnnotationFactory() {
            ...
            public Object getValueFromNode(Node node, String elementName, 
                ...
                if (elementName.equals("properties")) {
                    ...
                    PersistenceProperty[] props = new PersistenceProperty[names.getLength()];
                    for (int i = 0; i < names.getLength(); i++) {
                        ...
                        props[i] = AnnotationProxy.newProxyInstance(
                                PersistenceProperty.class, ctx.getClassLoader(), 
