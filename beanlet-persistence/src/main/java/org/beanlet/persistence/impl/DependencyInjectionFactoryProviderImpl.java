...
public final class DependencyInjectionFactoryProviderImpl extends 
    ...
    public List<DependencyInjectionFactory> getDependencyInjectionFactories(
        ...
        if (PersistenceConstants.isSupported()) {
            factories.add(new EntityManagerFactoryDependencyInjectionFactoryImpl(configuration));
            factories.add(new EntityManagerDependencyInjectionFactoryImpl(configuration));
        }
