 ...
 * {@code AfterCompletioon} annotation is applied MUST fulfill all of the
 * following criteria:
 * <ul>
 * <li>The method MUST specify a boolean parameter.
 * <li>The method MAY return any type.
 * <li>The method MUST NOT throw a checked exception.
 * <li>The method on which {@code AfterCompletion} is applied MAY be
