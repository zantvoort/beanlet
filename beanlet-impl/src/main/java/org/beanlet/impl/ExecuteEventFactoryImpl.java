 ...
 */
public final class ExecuteEventFactoryImpl implements EventFactory {

    private final Set<Class<? extends Event>> eventTypes;
 
    public ExecuteEventFactoryImpl(ComponentConfiguration configuration) {
        Set<Class<? extends Event>> tmpSet = 
                new LinkedHashSet<Class<? extends Event>>();
        tmpSet.add(ExecuteEventImpl.class);
