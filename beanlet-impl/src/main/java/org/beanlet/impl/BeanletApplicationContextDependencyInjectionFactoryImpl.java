 ...
 */
public final class BeanletApplicationContextDependencyInjectionFactoryImpl extends
        AbstractDependencyInjectionFactory<Inject> {
    
    public BeanletApplicationContextDependencyInjectionFactoryImpl(
    ...
    public boolean isSupported(ElementAnnotation<? extends Element, Inject> ea) {
        return BeanletApplicationContext.class.isAssignableFrom(getType(ea));
    }
    ...
    public Injectant<?> getInjectant(
        ...
        return new InjectantImpl<Object>(BeanletApplicationContext.instance(), true);
    }
