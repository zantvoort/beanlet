 ...
 */
public final class FactoryMetaDataImpl extends AbstractMetaData implements 
        FactoryMetaData, MetaData {
    
    private final Method method;
    
    public FactoryMetaDataImpl(Method method, String description) {
    ...
    public String toString() {
        return "FactoryMetaData{description=" + getDescription() + "}";
    }
}
