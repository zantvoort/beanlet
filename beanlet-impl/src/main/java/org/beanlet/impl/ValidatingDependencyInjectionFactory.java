 ...
 */
public final class ValidatingDependencyInjectionFactory implements 
        DependencyInjectionFactory {
    
    private final ComponentConfiguration<?> configuration;
    private final DependencyInjectionFactory factory;
    
    public ValidatingDependencyInjectionFactory(
    ...
    public List<DependencyInjection> getConstructorDependencyInjections(
        ...
        for (DependencyInjection injection : 
            ...
            list.add(new ValidatingDependencyInjection(configuration, injection));
        }
