 ...
 */
public final class StopBeanletConfigurationValidatorImpl extends
        SingleElementBeanletConfigurationValidator<Stop> {
    
    public Class<Stop> annotationType() {
        return Stop.class;
    }
    ...
    // PENDING: Only proxy beanlets or singleton beanlets MAY declare a Stop method?
}
