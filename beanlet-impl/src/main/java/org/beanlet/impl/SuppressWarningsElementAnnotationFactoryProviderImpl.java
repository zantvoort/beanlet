 ...
 */
public final class SuppressWarningsElementAnnotationFactoryProviderImpl extends
    ...
    public List<ElementAnnotationFactory> getElementAnnotationFactories() {
        ...
        ElementAnnotationFactory factory = new AbstractElementAnnotationFactory() {
            ...
            public Class<? extends Annotation> annotationType() {
                return org.beanlet.SuppressWarnings.class;
            }
            public Object getValueFromNode(Node node, String elementName, 
                ...
                if (elementName.equals("value")) {
                    ...
                    Node nameNode = map.getNamedItem("value");
                    if (nameNode != null) {
                        return new String[] {nameNode.getNodeValue()};
                    } else {
                        NodeList list = (NodeList) xpath.evaluate(
                                "./:suppress-warning/@value", node, XPathConstants.NODESET);
                        String[] names = new String[list.getLength()];
                        for (int i = 0; i < list.getLength(); i++) {
                            names[i] = list.item(i).getNodeValue();
                        }
                        return names;
                    }
                } else {
