 ...
 */
public final class BeanletExceptionHandlerProviderImpl extends AbstractProvider 
        implements ComponentExceptionHandlerProvider {
    
    public ComponentExceptionHandler getComponentExceptionHandler(
            ComponentConfiguration configuration) {
        return new BeanletExceptionHandlerImpl();
    }
}
