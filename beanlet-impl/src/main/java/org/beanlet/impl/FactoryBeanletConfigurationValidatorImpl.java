 ...
 */
public final class FactoryBeanletConfigurationValidatorImpl extends
        SingleElementBeanletConfigurationValidator<Factory> {
    
    public Class<Factory> annotationType() {
