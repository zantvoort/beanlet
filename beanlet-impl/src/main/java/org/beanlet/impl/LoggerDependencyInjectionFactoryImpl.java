 ...
 */
public final class LoggerDependencyInjectionFactoryImpl extends
        AbstractDependencyInjectionFactory<Inject> {
    
    private final BeanletConfiguration<?> configuration;
    
    public LoggerDependencyInjectionFactoryImpl(
    ...
    public boolean isSupported(ElementAnnotation<? extends Element, Inject> ea) {
        return Logger.class.isAssignableFrom(getType(ea));
    }
    ...
    public Injectant<?> getInjectant(
        ...
        return new InjectantImpl<Object>(
                Logger.getLogger(configuration.getComponentName()), true);
    }
