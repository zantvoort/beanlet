 ...
 */
public final class ScheduleBeanletConfigurationValidatorImpl extends
        SingleElementBeanletConfigurationValidator<Schedule> {
    
    public Class<Schedule> annotationType() {
