...
import org.beanlet.impl.metadata.StopMetaDataImpl;
 ...
 */
public final class StopBeanletProviderImpl extends 
    ...
    public List<InvocationFactory> getInvocationFactories(
        ...
        if (method != null) {
            ...
            // The Stop method is not supported by the underlying object,
    ...
    public List<EventFactory> getEventFactories(
            ComponentConfiguration configuration) {
        Class<? extends Event> cls = StopEventImpl.class;
    ...
    public <T> List<ComponentLifecycle<T>> getComponentLifecycles(
        ...
        Method method = getMethod(configuration);
        if (method != null) {
            lifecycles.add(new StopBeanletLifecycleImpl<T>());
        }
    ...
    public List<MetaData> getMetaData(ComponentConfiguration configuration) {
        ...
        if (method == null) {
            ...
            if (configuration instanceof BeanletConfiguration) {
                Stop stop = ((BeanletConfiguration) configuration).
                        getAnnotationDomain().getDeclaration(Stop.class).
                        getAnnotation(MethodElement.instance(method));
                assert stop != null;
                MetaData m = new StopMetaDataImpl(method, stop.
                        description());
