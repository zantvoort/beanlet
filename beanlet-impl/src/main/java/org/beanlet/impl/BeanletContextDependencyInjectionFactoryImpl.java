 ...
 */
public final class BeanletContextDependencyInjectionFactoryImpl extends
        ParameterizedTypeAwareDependencyInjectionFactory {
    
    public BeanletContextDependencyInjectionFactoryImpl(BeanletConfiguration<?> configuration) {
        super(configuration);
    }
    ...
    public boolean isSupported(ElementAnnotation<? extends Element, Inject> ea) {
        ...
        if (BeanletContext.class.isAssignableFrom(type)) {
    ...
    public Injectant<?> getInjectant(
        ...
        return new InjectantImpl<Object>(BeanletContextImpl.instance(ctx), false);
    }
}
