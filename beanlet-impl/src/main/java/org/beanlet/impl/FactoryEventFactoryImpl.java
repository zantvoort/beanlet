 ...
 */
public final class FactoryEventFactoryImpl implements EventFactory {

    private final Set<Class<? extends Event>> eventTypes;

    public FactoryEventFactoryImpl(ComponentConfiguration<?> configuration) {
        Set<Class<? extends Event>> tmpSet = 
                new LinkedHashSet<Class<? extends Event>>();
        tmpSet.add(FactoryEventImpl.class);
        eventTypes = Collections.unmodifiableSet(tmpSet);
    }
