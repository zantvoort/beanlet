 ...
 */
public final class StatefulBeanletObjectPoolProviderImpl extends 
    ...
    public <T> ComponentObjectPool<T> getComponentObjectFactory(
        ...
        if (beanlets.isStateful()) {
            pool = new StatefulBeanletObjectPoolImpl<T>(
                    configuration.getComponentName(), beanlets.isLazy(),
                    beanlets.getStateful().reentrant(), 
