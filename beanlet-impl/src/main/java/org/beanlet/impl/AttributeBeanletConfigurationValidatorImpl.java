 ...
 */
public final class AttributeBeanletConfigurationValidatorImpl extends
        AbstractBeanletConfigurationValidator<Attribute> {
    
    public Class<Attribute> annotationType() {
