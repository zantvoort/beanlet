 ...
 */
public final class JavaPreDestroyInterceptorBeanletConfigurationValidatorImpl extends
        AbstractBeanletConfigurationValidator<PreDestroy> {
    
    public Class<PreDestroy> annotationType() {
