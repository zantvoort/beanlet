 ...
 */
public final class InterceptorsClassResolverImpl implements ClassResolver {
    
    public List<Class> getClasses(AnnotationDomain annotationDomain) {
        List<Class> list = new ArrayList<Class>();
        for (ElementAnnotation<Element, Interceptors> e : annotationDomain.
                getDeclaration(Interceptors.class).
                getElements()) {
            Interceptors annotation = e.getAnnotation();
