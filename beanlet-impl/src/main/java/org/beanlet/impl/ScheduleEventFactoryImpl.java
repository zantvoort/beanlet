 ...
 */
public final class ScheduleEventFactoryImpl implements EventFactory {

    private final Set<Class<? extends Event>> eventTypes;
 
    public ScheduleEventFactoryImpl(ComponentConfiguration configuration) {
        Set<Class<? extends Event>> tmpSet = 
                new LinkedHashSet<Class<? extends Event>>();
        tmpSet.add(ScheduleEventImpl.class);
        this.eventTypes = Collections.unmodifiableSet(tmpSet);
    }
