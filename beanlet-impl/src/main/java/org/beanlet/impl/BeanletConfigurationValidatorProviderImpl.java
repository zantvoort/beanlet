...
public final class BeanletConfigurationValidatorProviderImpl extends AbstractProvider
    ...
    public List<BeanletConfigurationValidator> getBeanletConfigurationValidators() {
        ...
        list.add(new PostConstructInterceptorBeanletConfigurationValidatorImpl());
        list.add(new PreDestroyBeanletConfigurationValidatorImpl());
        list.add(new PreDestroyInterceptorBeanletConfigurationValidatorImpl());
        list.add(new ExecuteBeanletConfigurationValidatorImpl());
        list.add(new ScheduleBeanletConfigurationValidatorImpl());
        list.add(new StartBeanletConfigurationValidatorImpl());
        list.add(new StopBeanletConfigurationValidatorImpl());
        
        try {
            Class.forName("javax.annotation.PostConstruct");
            list.add(new JavaPostConstructBeanletConfigurationValidatorImpl());
            list.add(new JavaPostConstructInterceptorBeanletConfigurationValidatorImpl());
        } catch (ClassNotFoundException e) {
        }
        try {
            Class.forName("javax.annotation.PreDestroy");
            list.add(new JavaPreDestroyBeanletConfigurationValidatorImpl());
            list.add(new JavaPreDestroyInterceptorBeanletConfigurationValidatorImpl());
        } catch (ClassNotFoundException e) {
        }
